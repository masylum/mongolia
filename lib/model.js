...
module.exports = function (db, collection_name) {
   ...
   */
  MODEL.beforeCreate = function (documents) {
   ...
   * @param {Function} callback [optional]
   */
  MODEL.afterCreate = function (documents) {
  };
   ...
   * @param {Function} callback [optional]
   */
  MODEL.beforeUpdate = function (query, update) {
   ...
   * @param {Function} callback [optional]
   */
  MODEL.afterUpdate = function (query, update) {
  };
   ...
   * @param {Function} callback [optional]
   */
  MODEL.beforeRemove = function (query) {
  };
   ...
   * @param {Function} callback [optional]
   */
  MODEL.afterRemove = function (query) {
  };
